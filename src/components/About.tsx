    ...
    <section id="about" className="section-padding py-20" ref={sectionRef}>
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-brand-navy mb-2 reveal-animation">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="reveal-animation">
            <div className="glass-card p-6 relative">
              <div className="absolute -top-3 -left-3 w-20 h-20 bg-brand-blue/10 rounded-full"></div>
              <div className="relative z-10 space-y-4">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-brand-blue/10 rounded-full flex items-center justify-center mr-4">
                    <span className="text-brand-blue font-bold">17+</span>
                  </div>
                  <h3 className="text-xl font-medium text-brand-navy">Years of Experience</h3>
                </div>
            ...
            <div className="glass-card p-6 mt-6 relative">
              <div className="absolute -bottom-3 -right-3 w-16 h-16 bg-brand-blue/10 rounded-full"></div>
              <div className="relative z-10">
                <h3 className="text-xl font-medium text-brand-navy mb-4">Contact Information</h3>
                <ul className="space-y-2 text-brand-gray">
                  <li className="flex items-start">
                    <span className="font-medium mr-2">Email:</span>
                    <a href="mailto:Ankurtyagi007@gmail.com" className="hover:text-brand-blue transition-colors">
                      Ankurtyagi007@gmail.com
                    </a>
                  </li>
                  <li className="flex items-start">
                    <span className="font-medium mr-2">Phone:</span>
                    <a href="tel:+14377791796" className="hover:text-brand-blue transition-colors">
                      437-779-1796
                    </a>
                  </li>
                  <li className="flex items-start">
          ...
          <div className="space-y-6 reveal-animation">
            ...
            <div className="pt-4">
              <h3 className="text-xl font-medium text-brand-navy mb-4">Seeking a challenging role where I can:</h3>
              <ul className="space-y-2 text-brand-gray list-disc pl-5">
